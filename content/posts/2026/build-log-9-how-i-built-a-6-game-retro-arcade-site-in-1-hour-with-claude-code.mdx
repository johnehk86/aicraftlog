...
> **Play the game:** [Pixel Adventure — A Super Mario-inspired platformer](https://pixel-adventure.craftai.work)
> **Watch the video:** [Built a Super Mario Game in 15 Minutes with Claude Agent Teams (Agent Teams Tutorial)](https://youtu.be/CPCrp_TBhl8)
...
|---|---|
| **Homing Missiles** | Missiles that track the player's position every frame |
| **Spawn Interval Reduction** | Decreases from 0.8s → 0.15s over time |
| **Simultaneous Spawn Increase** | 1 missile → up to 6 at once (~40 per second in late game) |
| **Missile Speed Increase** | Base 1.8 → max 4.3 (player speed fixed at 4) |
...
| First commit to completion | Same day |
